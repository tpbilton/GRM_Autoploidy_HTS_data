...
epsilon = 0.001 # sequencing error parameter
...
locfolder = "./" ## Location of where files are to be written to
...
## linkage map file
nsnp_per_chrom =  table(sample(1:nChroms,prob=chr_len/sum(chr_len), size=nSnps, replace=T)) 
